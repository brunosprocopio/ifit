...
RSpec.describe PedidosHasPratosController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # PedidosHasPrato. As you add validations to PedidosHasPrato, be sure to
  ...
  # PedidosHasPratosController. Be sure to keep this updated too.
  let(:valid_session) { {} }
