...
RSpec.describe PratoProntosController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # PratoPronto. As you add validations to PratoPronto, be sure to
  ...
  # PratoProntosController. Be sure to keep this updated too.
  let(:valid_session) { {} }
