...
RestaurantesProximo.create :id => 1, :sessao_id => 5, :restaurante_id => 1
RestaurantesProximo.create :id => 2, :sessao_id => 5, :restaurante_id => 2
RestaurantesProximo.create :id => 3, :sessao_id => 5, :restaurante_id => 3