...
RSpec.describe "alimento_precos/edit", type: :view do
  before(:each) do
  ...
  xit "renders the edit alimento_preco form" do
    render

    assert_select "form[action=?][method=?]", alimento_preco_path(@alimento_preco), "post" do
